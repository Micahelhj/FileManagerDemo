 ...
 * 类描述：日志服务，日志默认会存储在SDcar里如果没有SDcard会存储在内存中的安装目录下面。
 * <p/>
 ...
 * <p/>
 * 创建人：Michael-hj
 * 创建时间：2016/5/13 0013 10:47
 * 修改人：Michael-hj
 * 修改时间：2016/5/13 0013 10:47
 * 修改备注：
 */
public class WdLogService extends Service {
    ...
    private void init() {
        LOG_PATH_MEMORY_DIR = getFilesDir().getAbsolutePath() +
                File.separator
                + "Wonders"
                + File.separator
                + "log";
